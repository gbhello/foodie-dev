DROP TABLE if exists carousel;;/*SkipError*/
...
DROP TABLE if exists category;;/*SkipError*/
...
DROP TABLE if exists users;;/*SkipError*/
CREATE TABLE users(
...
DROP TABLE if exists items;;/*SkipError*/
CREATE TABLE items(
...
DROP TABLE if exists items_img;;/*SkipError*/
...
DROP TABLE if exists items_spec;;/*SkipError*/
...
DROP TABLE if exists items_param;;/*SkipError*/
...
DROP TABLE if exists items_comments;;/*SkipError*/
...
DROP TABLE if exists orders;;/*SkipError*/
CREATE TABLE orders(
...
DROP TABLE if exists order_items;;/*SkipError*/
...
DROP TABLE if exists order_status;;/*SkipError*/
